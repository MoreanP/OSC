...
if __name__ == "__main__":
    ...
    replay_buffer.convert_D4RL_finetune(d4rl.qlearning_dataset(env, dataset=dataset))
    ...
    # offline pretrain score
    eval_episodes = 100 if 'antmaze' in args.env else args.eval_episodes
    d4rl_score = eval_policy(args, 0, video, logger, policy, args.env,
